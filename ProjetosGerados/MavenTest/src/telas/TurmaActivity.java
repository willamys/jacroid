...
public class  TurmaActivity extends Activity {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.turmaactivity);
		//initControls();
		...
		buttonCad.setOnClickListener(new View.OnClickListener(){
			...
			public void onClick(View arg0) {
				Intent i = new Intent(TurmaActivity.this, TurmaCadastrarActivity.class);
		...
		buttonList.setOnClickListener(new View.OnClickListener(){
			@Override
			public void onClick(View arg0) {
				Intent i =  new Intent(TurmaActivity.this, TurmaListarActivity.class);
				startActivityForResult(i, 1);
			}
		});
