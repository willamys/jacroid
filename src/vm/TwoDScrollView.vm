 ...
 */
  ...
  * the parameter top.
  *
  *  topFocus           look for a candidate is the one at the top of the bounds
  *                           if topFocus is true, or at the bottom of the bounds if topFocus is
  *                           false
  *  top                the top offset of the bounds in which a focusable must be
  *                           found (the fading edge is assumed to start at this position)
  *  preferredFocusable the View that has highest priority and will be
 ...
 */
  ...
  * focus.</p>
  *
  *  direction the scroll direction: {@link android.view.View#FOCUS_UP}
